...
var playableMap = [["                                                                                                                                             ", "                                                                                                                                             ", "                                                                                                                                             ", "                                                                                                                                             ", "                                                                                                                                             ", "                                                                                                                  ====                       ", "                                                                                               %  $ $  %         =====                       ", "                            $ $ $                                                                               ======                       ", "                          $       $                                                                            =======                       ", "                                                                                             ============     ========                       ", "                                                                                       ==                     ========                       ", "           % %           ==========                                                   ==                      ========                       ", "                        ==        ==                                                 ==                       ========                       ", "                       ==          ==       ^               ==     ==               ==      ^   ^   ^   ^     ========  $ $ $ $              ", "  -+       ===        ==            ==                     ==       ==      ^      ==                         ========  $ $ $ $      -+      ", "  ()      =====      =_  $ $ $ $ $                        _=         =_           _=                          _=======               ()      ", "============================================================         ========================================================================", "============================================================         ========================================================================", "============================================================         ========================================================================"], ["                                                                          ===========                        ", "                                                                         ===========      ^                  ", "                                                                       ===========  ===========^       ^             ", "                                                                    ^ ===========             ===========                ", "                                                                    ===========                           =========== ", "                                                                   ===========                                            ===========   ", "                                                                 ===========                                      =========== ", "                                                               ===========                                             =========== ", "         ============================                      ^ ===========                                                               ", "                                                           ===========                                 ^^     =========== ", "                                                         ===========                                  =========== ", "                                                       ===========                           ^    =========== ", "                                                     ===========                            ===========   ", "     %    =*=%=                                    ============                                    =============== ", "  -+                                               ===========                -+                    ====================       ", "  ()                         ^       ^           _==========                  ()          $$$$$$       ======================  ", "======================================================                    =====     =========================  "], ["£                                                                                                  $$$$$                              £", "£                                                                            ^^^            $$$$$          ^ $$$$$     ^                   £", "£     ! ! ! ! ! ! ! ! ! ! ! !                                            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!             £", "£              $$$$$$                                                 !!!!!!!!!!!!!!!!!!!!!!!!!!         !!!!!!!!!!!!!!!!!!!!!!!!!!  ^    £", "£             $$$$$$$                $$$$$          $$$$$$          !!!!!!!!!!!!!!!!!!!!!!!!!!                 !!!!!!!!!!!!!!!!!!!!!!!!!!       $$$$                             £", "£           $$$$$$$$$$                                            !!!!!!!!!!!!!!!!!!!!!!!!!!                      !!!!!!!!!!!!!!!!!!!!!!!!!!                                   -+£", "£                               x      $$$$$$     $$$$$$       !!!!!!!!!!!!!!!!!!!!!!!!!!                            !!!!!!!!!!!!!!!!!!!!!!!!!!              $$$             !!()£", "£     %    @@@@@@              xx                            !!!!!!!!!!!!!!!!!!!!!!!!!!                                 !!!!!!!!!!!!!!!!!!!!!!!!!! ^                      !!£", "£ -+                            xxx           $$$$$          !!!!!!!!!!!!!!!!!!!!!!!!!!                                     !!!!!!!!!!!!!!!!!!!!!!!!!!      !!       !!£", "£ ()                z   z      xxxx      ^           ^     !!!!!!!!!!!!!!!!!!!!!!!!!!                                          !!!!!!!!!!!!!!!!!!!!!!!!!!       !!     £", "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  !!!!!!!!!!!!!!!!!!!!!"], ["==   -+   $$$$                                  $$                                                        ", "     ()                                         ==                                                   ", "     ==                                                                                            ", "                 $$$                     ==      ==                                                     ", "          ==                          ^^                                                           ", "                ^^                   ==              ==                                              ", "               ==       $$$      ^^                                                                 ", "                                ==                      ==                                                ", "                     ^^                                      ^                                                                                 ", "                    ==    *   ==                            ==                                           ", "                                                                                                         ", "                         ==                                    ==                                          ", "                                                                                                              ", "                                                                  ==                                           ", "                                                              ==                                          ", "                                                                                                       ", "                   ^^^^^^^^^^                                       ==                                          ", "                                                      ^                                                                ", "                                                      ==", "                                                  ==", "                                         ", "                    ^^                                                                                                     ", "                                              ==                                                     -+                    ", "                ^^                                   ==                                $$          ^ ()                                        ", "                                                                                                   ====                                       ", "                                                       ===                 ^                 ^      ", "                                                                          ==     =  =      ====                                           ", "                  ^^^^                                         ===                                          ", "                                                                   ===                                          ", "                                                                                                                  ", "                                                                                                                      "], ["£                                                             !                            £", "£     ! ! ! ! ! ! ! ! ! ! ! !                           !!!                            -+   £", "£                                        *           !!!                           xxxx()  £", "£             $$$           $$$      x             !!!                          xxxx         £", "£             !!             zz          *        !!!                        xxxx     £", "£        !!!        !!1               x          !!!                     xxxx    £", "£     %    @@@@@@     zzzz     !!!    xx        !!!                  xxxx     £", "£ -+                            xxx       !!!      x    ^           xxxx      £", "£ ()    zzzzzzzzz       zzzzzz     ^    zzzzzzzzzzzx zzzz      xxxx         £", "!!!!!!!!!!!!!!!!!  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"], ["=======      ===   ========    ==========                                                                    ", "      x                                                                                                ", "      x  z             ====xxx              ==                                                        ", "      ====   -+          x                    =                                                                  ", "      x   z  ()    x===xxx               =                                                        ", "      x   x======                   =                                                        ", "      x                          =                                                        ", "      x                         =                                                        ", "      x                       =                                                        ", "  ^   x                       =                                                        ", "xxxxxx                   =                                                        ", "                       =                            ", "     ===             =                      ", "        xxx==     =                           ", "              x                                                                                           ", "              x     ========                                                                                     ", "              xxxxxx        =======   ^                                                                          ", "                                 =======     ^                                                                 ", "               ^                         =======                                                                ", "               ===                                                                                          ", "          ===      ===                                                                                    ", "-+    ===              ^^          ^          =======", "()                     =======     ===                 ", "()    === ^                 ===    =======     ===                 ", "()       ====                              ^                      ", "()            ====     ===    =======     ===                 "], ["                                                                                                                                                                                                                     ", "       =                  %                                                                                                                                                                                            ", "                                         ^                                                                                                                                                                           ", "   *                  $          ==     ====                                         %                                                                                                                                             ", "                      $    =                                                            ^                                                                                                                              ", "       =                                %       x                                       ==    x  xxx                                                                                                                          ", "                      *                                                                            x                                                                                                                     ", "   *                                 x               x                              ==             x                                                                                                                      ", "       ^^                   =                                                                      x                                                                                                                   ", "       =                                x                    x                   %                 x                                                                                                         ", "                       %                                      x                                    x                                                                                                       ", "   %        =              =                                   x                ==                 x                                                                                                            ", "     ^^                                                         x                                  x                                                                                                        ", "       x           =    =                                         x            x                    x                                                                                                       ", "           x                                                       x         x                      x                                                                                                             ", "             ^^                                                    x     x         x               x                                                                                                                      ", "   *                                                                x                              x                                                                                                       ", "        x                                                                  x      x                x                                                                                                        ", "                                                                               x                   xxx                                                                                                      ", "   %                                                                                                    x                                                                                                 ", "                                                                                                                                                                                                        ", "      ^^                                                                                              x                                                                                                    ", "       =                                                                                           ==                                                                                                      ", "                                                                                x              x                                                                                                            ", "                                                                                                                                                                                                           ", "   *                                                                     =          =   =                                                                                                                   ", "-+       x                                                                                                                                                                                                    ", "()  = =                                                                                                                                                                                                    ", "=                                                                                                                                                                                                    ", "                                                                                                                                                                                                   ", "     =                                                                                                                                                                                                   ", "     =                                                                   -+                                                                                                                                ", "     =                                                                   ()                                                                                                                                ", "     =                                                                   ()                                                                                                                                "], ["                                                       £", "                                      $$             £", "                                     %%                                   ", "                                                                       ", "                                   x  x                 £", "                                                   $$$$$$$$                    ", "                                      $                                 ", "                    x                x     x       x x         £", "                                    $                                   ", "              x           x        x           x        x                 £", "                                                                       ", "           x x             x   x         x           x             £", "                                                                       ", "        x   x              x x       x              x        £", "-+                                                                       ", "()     x      x       x        x     x                  x         £", "                                                                       ", " x         x      x          x   x                      x        ", "                  x                                                     ", "x           xxxxx x       xxxxxxx                       x     xxxxxxxxxxxxxxxxxxxxxxxxxxxxx", "                  x                                       x", "                  xxxx    xxx                                     x            ", "                x                                         x                       ", "            x x x           x                                              ", "                x                                                                      ", "            x                                                                     ", "                                         x                       x                         ", "            x                       x        x                                        ", "                x                  x             x             x                         ", "                   x                                                                ", "                     x           x                  x         x                 ", "                                                       x   x                           ", "                             x                                                    ", "                x                                                               ", "                     -+   x                                                         ", "                     ()                                                             ", "                     ()                                                           ", "                     x                                                           "], ["                                                                                                                                                                                           ", "   =======   =====      ======    ======                                                                                                                                               -+ ", "                                                     ^  ^^^             ^                                                                                                                 ()", "                  ^^^^^^                          ================  ===     ==                                                                                                    ==    % ", "                                                                 ^^^^                                                                                                        %", "                                                            $$    ===                                                                                                     %", "                                           ^^^               $$$$                                                                                                      % ", "        *          %                                     $$$$$$                                                                                                     %", "                                                               ^^^^^^                                                                                            %", "                                             ===            ====================                                                                             % ", "             ^               ^                                                           *                                                                %", "           ===========================               $^                                                                                                %", "             ^                                         ==   *                                                ^                                      %", "                                                                           	           =                      %=   =     *                     %", "     %    =*=%=                                            =             %%%%         =    =                    =                    %       %     ", "    -+                                  ^^^^                                             =          =                           =             %          ", "    ()     ^^      ^^^^^^                                                      =                                    ^^                       =             %      ", "===============================   ==  = =   =  =  ========         ================         ==   =======   ========           ==    ==     ============== "], ["£                                                  @@@                                                     £", "£                                                                                                          £", "£                                                   !                                                      £", "£                                           **                                                      £", "£                                  z           $$$     !!    !!        $$$$$$$$$$$$$$$$$$$$$£", "£                                  x          !!!                            £   £   £   £      £    £", "£     %    @@@@@@                 xx                             xxx%%         %      %      %     £", "£   -+                           xxx                                                               £", "£   ()              z   z       xxxx        xx                     xx£       !!     !!     !!               ", "!!!!!!!!!!!!!!!!!!     !!!!!!!       !!    !!!!!!  !!!!!!xxxxxx!!!!!!!!!!!                                  ", "                                                                                                             ", "                                                                              %             %           ", "                    *                                      -+                        xx           xx     ", "                   £                                       ()                                       ", "                   !!!!!                    !!!!!!!!!!!!!!!!!!!!!!!   x x      xx         xx           "], ["£                                                                                                          £", "£     ! ! ! ! ! ! ! ! ! ! ! !                                                                                £", "£                                                                                                            £", "£      xxxxx       xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx                               £", "£                                                                                                              £", "£                               x                                                                              £", "£                               x                                                                              £", "£                               x                                                                              £", "£                               x                                                                            £", "£                               x                                                                            £", "£     %    @@      @@@@              xx                                                                       £", "£    -+     $   $$   $$$   $$$$      $$$$$$      $$$$$$$        xxx                                            £", "£    ()                                        ()                                                               £", "!xx!!!!!!!!!!!!!         !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                            x", "                                                                                                                x", "                                                                                                                  ", "                                                                                 $$$$$                             ", "-+xxx  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx    xxxxxxxxxxxxxx    xxxxxx   xxxxxx    xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx      ", "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$                ", "                $$     xxxxx                                                                                 xxxxxxx", "-+                                      $$                                                               xxxxxxx", "()   x          xxxx                   xxxxxxxxxxxxxxxxx                          xx     xx   x    xxxxxxxx                        x", "()          x   xxxx    %              xxx            xx         x               xx  x     x            x", "()              xxxx                   xxx            xx                      xx    x        x           x", "()       x      xxxx        x          xxx            xx      xx            xx      x          x          x", "()                                     xxx            xx                  xx        x            x        x", "()                    xxx              xxx            xx   %            xx          x              x        x", "()                     xxx             xxx            xx         xx   xx            x                x       x", "()               x       xxx           xxx            xx            xx              x                 x", "()    xxxxxx           xxxxxxxxxxxxxxxxxxx                 xxxxxxxxxxxxxx              xxxxxxxxxxxxxxxxxxx                                        x"]];
...
exports.info = void 0;
var info = [["Get Vaccinated.. Encourage Others"], ["Kill that hestitation regarding vaccines or that hesitation will kill you"], ["Don't succumb to viruses.. Make viruses succumb when they attack you. Happens only when you are fully immune. Believe in what great researchers are saying"], ["Live, attenuated vaccines fight viruses and bacteria. These vaccines contain a version of the living virus or bacteria that has been weakened so that it does not cause serious disease in people with healthy immune systems. Because live, attenuated vaccines are the closest thing to a natural infection, they are good teachers for the immune system. Examples of live, attenuated vaccines include measles, mumps, and rubella vaccine (MMR) and varicella (chickenpox) vaccine. Even though they are very effective, not everyone can receive these vaccines. Children with weakened immune systems—for example, those who are undergoing chemotherapy—cannot get live vaccines."], ["It is always better to prevent a disease than to treat it after it occurs."], ["Vaccination is a highly effective, safe and easy way to help keep your family healthy."], ["Your child is exposed to thousands of germs every day in his environment. This happens through the food he eats, air he breathes, and things he puts in his mouth."], ["Babies are born with immune systems that can fight most germs, but there are some deadly diseases they can’t handle. That’s why they need vaccines to strengthen their immune system."], ["Vaccines use very small amounts of antigens to help your child’s immune system recognize and learn to fight serious diseases. Antigens are parts of germs that cause the body’s immune system to go to work."], ["Thirty years ago, vaccines used 3,000 antigens to protect against 8 diseases by age two. Today, vaccines use 305 antigens to protect against 14 diseases by age two."], ["For some vaccines (primarily inactivated vaccines), the first dose does not provide as much immunity as possible. So, more than one dose is needed to build more complete immunity. The vaccine that protects against the bacteria Hib, which causes meningitis, is a good example."]];
exports.info = info;
...
loadSprite("shoot", "mPlhKAi.png"); //Vaccine Info Scene begins
...
scene("game", function (_ref) {
  ...
  var bgColor = add([rect(100000000000000, 1000000000000000), color(0, 10, 24), layer("bg", "ui"), fixed()]); //level configuration
  ...
  var levelCfg = {
    ...
    x: function x() {
      return [sprite("blue-steel"), solid(), area(), scale(0.5)];
    }
  ...
  var player = add([sprite("mario"), solid(), pos(0, 0), body(), big(), area(), origin("bot")]); //Now make the mushroom move
  ...
  onUpdate("dangerous", function (d) {
    ...
    var y_dist = d.pos.y - (player.pos.y - 20);
    console.log("X dist: " + x_dist + ", Y dist: " + y_dist); // Check how far away the guy is and if it's already moving.
    // Bias x distance over y distance

    d.moving = d.moving ? true : Math.abs(x_dist) < AGRO_RANGE_X && Math.abs(y_dist) < AGRO_RANGE_Y;
    if (!d.moving) return;
    var movement = 3 * ENEMY_SPEED * (level + 1);
    var x_move = movement;
  ...
  onUpdate("bullet", function (b) {
    //destroy(b);
    b.move(ENEMY_SPEED * 3, 0); // whenever a bullet is released decrement the time given to it.
  ...
  if (isTouch()) {
    ...
    var rightButton = add([sprite("d"), pos(125, 450), opacity(0.5), fixed(), area()]);
    var actionButton = add([sprite("highjump"), pos(750, 450), opacity(0.5), fixed(), area()]);
    var shootButton = add([sprite("shoot"), pos(650, 450), opacity(0.5), fixed(), area()]); //TouchStart acts similar to a key press
...
scene("lose", function (_ref2) {
  ...
  add([text("Game Over. Going Back to Main Menu in 2 seconds"), color(200, 50, 10), scale(0.5), pos(window.innerWidth / 3 - 300, window.innerHeight / 2 + 30)]); // start the game
  // onKeyPress("space", () => {
  //   go("game", { level: 0, score: 0 });
  // });
