...
scene("game", function (_ref) {
  ...
  onUpdate("dangerous", function (d) {
    if (d.pos.x > player.pos.x) d.move(-ENEMY_SPEED * 3 * (level + 1), 0);else if (d.pos.x < player.pos.x) d.move(ENEMY_SPEED * 3 * (level + 1), 0);
    if (d.pos.y < player.pos.y) d.move(-ENEMY_SPEED * (level + 1), ENEMY_SPEED * 3 * (level + 1));else if (d.pos.y > player.pos.y) d.move(ENEMY_SPEED * (level + 1), -ENEMY_SPEED * 3 * (level + 1)); // else if (d.pos > player.pos) d.move(-ENEMY_SPEED, -ENEMY_SPEED);
