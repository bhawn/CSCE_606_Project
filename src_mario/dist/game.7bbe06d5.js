...
exports.default = no;
},{}],"PlayableMap.js":[function(require,module,exports) {
"use strict";
...
scene("game", function (_ref) {
  ...
  if (isTouch()) {
    ...
    var onTouchChanged = function onTouchChanged(_, pos) {
    ...
    onTouchEnd(onTouchChanged); // onTouchEnd
